...
export class UserLoginComponent implements OnInit {
  ...
  /**
   * The function returns a promise that resolves to a token generated by the reCAPTCHA service
   * @returns A promise that resolves to the token.
   */
  // captchaVal() {
  //   return firstValueFrom(this.recaptchaV3Service.execute('importantAction'))
  //     .then((data) => {
  //       this.captchaToken = data;
  //       console.log('token generated:', this.captchaToken);
  //     })
  //     .catch((err) => console.log('error in captcha generation: ', err));
  // }

  async submitLoginForm() {
    // in case of promise returned by a method
    // const token = await this.captchaVal();

    await firstValueFrom(this.recaptchaV3Service.execute('importantAction'))
      .then((data) => {
        this.captchaToken = data;
        console.log('token generated:', this.captchaToken);
      })
    ...
    console.log('sending value for captcha');
...
// captcha generation without async-await

//  executeImportantAction(): void {
//   this.recaptchaV3Service.execute('importantAction').subscribe((token) => {
//     console.log('Captcha token is: ', token);
//     this.captchaToken = token;
//     console.log('captcha count:-', this.captchaCount);
//     this.captchaCount++;
//   });
// }
